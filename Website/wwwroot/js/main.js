...
function Add() {
    div.id = 'input' + ++x;
    div.innerHTML = '<input type="file" name="upload" id="uploadFile" /><br /> <button type="button" formnovalidate value="SendEmail" id="buttonSendEmailas">Отправить обращение</button>';
